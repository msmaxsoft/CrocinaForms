...
<div class="crocina-field crocina-field-<?php echo esc_attr( $slug ); ?> <?php echo esc_attr( $width_class ); ?>">
	<label for="crocina-input-<?php echo esc_attr( $slug ); ?>">
		...
		<input type="number" id="crocina-input-<?php echo esc_attr( $slug ); ?>" name="<?php echo esc_attr( $slug ); ?>" placeholder="<?php echo esc_attr( $placeholder ); ?>" <?php echo esc_attr( $required ); ?> <?php echo $helper_text ? 'aria-describedby="crocina-helper-' . esc_attr( $slug ) . '"' : ''; ?>>
	</label>
	<?php if ( $helper_text ) : ?>
